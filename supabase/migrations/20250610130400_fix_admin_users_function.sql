...
-- Fix the get_admin_users function to handle data type mismatches and improve error handling
...
-- Create a function to check current user authentication status

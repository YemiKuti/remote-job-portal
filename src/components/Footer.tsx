        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex gap-4 mt-4">
              ...
              <a href="https://www.instagram.com/africantechjobs/" className="text-gray-600 hover:text-primary" target="_blank" rel="noopener noreferrer">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/company/africantechjobs/" className="text-gray-600 hover:text-primary" target="_blank" rel="noopener noreferrer">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
